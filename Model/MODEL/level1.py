...
criteria = ["Cryptography & Key Management","Data Security and Privacy Management","Network Security"]
...
performance_matrix = np.array([[0.3, 0.4, 0.5,],
                               [0.7, 0.6, 0.5,],
                               [0.2, 0.3, 0.4,],
                               [0.4, 0.5, 0.6,],
                               [0.6, 0.7, 0.8,],
...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.label1 = ttk.Label(self, text="Cryptography & Key Management weight:")
        self.label1.grid(row=0, column=0, padx=5, pady=5)
        self.weight1 = ttk.Entry(self)
        self.weight1.grid(row=0, column=1, padx=5, pady=5)

        self.label2 = ttk.Label(self, text="Data Security and Privacy Management weight:")
        self.label2.grid(row=1, column=0, padx=5, pady=5)
        self.weight2 = ttk.Entry(self)
        self.weight2.grid(row=1, column=1, padx=5, pady=5)

        self.label3 = ttk.Label(self, text="Network Security weight:")
